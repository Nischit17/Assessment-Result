...
const Sidebar = () => {
  ...
  return (
    ...
    <div className="main-sidebar sidebar-style-2">
        ...
        <div className="sidebar-brand pb-4 mt-4 mb-4 pt-4 d-flex align-items-center justify-content-center">
            <a href="index.html" className="d-flex"><img src="" style={{width: "32px"}} /><span className="pl-2 logo-txt">Maturity<br />Spectrum 360</span></a>
          </div>
